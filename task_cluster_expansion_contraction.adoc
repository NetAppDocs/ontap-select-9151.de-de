...
+
** ESXi 8.0 U3 (verfügbar für ONTAP 9.15.1P4 oder eine neuere verfügbare Patch-Version)
** ESXi 8.0 U2
** ESXi 8.0 U1
** ESXi 8.0GA
** ESXi 7.0 U3
...
.Bevor Sie beginnen
* Wenn Sie ein Cluster mit mehreren Nodes bereitstellen, sollten Sie mit dem vertraut seinlink:https://docs.netapp.com/us-en/ontap-select/task_adm_connectivity.html["Prüfung der Netzwerkverbindung"].
