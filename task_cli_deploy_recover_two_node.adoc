...
....
+
Der `<ip_address>` Parameter ist die IP-Adresse der neuen Deploy Virtual Machine.
...
. Klicken Sie auf das *Model* neben `iscsi_target` und füllen Sie den Namenswert aus.
+
