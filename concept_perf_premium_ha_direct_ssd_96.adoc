...
| Große ONTAP Select-Instanz mit das (SSD) Software-RAID | 2171 MIB/s | 559 MIB/s | 954 MIB/s | 394 MIB/s | 564 MIB/s 
...
* 64 SIO-Prozesse, 1 Gewinde pro Prozessor
* 32 Volumes pro Node
* 1 x Dateien pro proc; Dateien sind jeweils 12000 MB
...
* Volumes pro Node: 32
* 1 x Dateien pro Prozessor; Dateien sind jeweils 12228 MB
