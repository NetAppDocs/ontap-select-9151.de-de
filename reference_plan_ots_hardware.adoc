...
* VMware ESXi 8.0 U3 (verfügbar für ONTAP 9.15.1P4 oder eine neuere verfügbare Patch-Version)
...
Weitere Informationen finden Sie im https://mysupport.netapp.com/matrix["NetApp Interoperabilitäts-Matrix-Tool, Fenster=_blank"].
...
* Intel Xeon Prozessoren für Server (weitere Informationen siehelink:https://www.intel.com/content/www/us/en/products/processors/xeon/view-all.html?Processor+Type=1003["Intel Xeon Prozessoren,window=_blank"])
...
Weitere Informationen finden Sie unter link:concept_lic_platforms.html["Verstehen Sie die Angebote für Plattformlizenzen"] .
...
NOTE: Die Plattformlizenz stellt zusätzliche Festplattenanforderungen bereit. Weitere Informationen finden Sie unter link:reference_plan_ots_storage.html["Storage und RAID"] .
